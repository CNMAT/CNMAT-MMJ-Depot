...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"bgcolor" : [ 0.156862745098039, 0.72156862745098, 0.447058823529412, 1.0 ],
					"cantchange" : 1,
					"fontsize" : 8.0,
					"id" : "obj-9",
					"maxclass" : "number",
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 206.0, 180.0, 46.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 121.0, 21.0, 17.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 140.0, 19.5, 16.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 40.0, 50.0, 56.0, 22.0 ],
									"text" : "cycle~ 1."
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 120.5, 16.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 28.0, 121.0, 28.0, 17.0 ],
					"text" : "Gain"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 17.0, 121.0, 16.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 138.0, 43.0, 19.0 ],
					"text" : "audio on",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 160.0, 74.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 67.0, 2.0, 12.0, 116.0 ]
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.313725490196078, 0.298039215686275, 0.298039215686275, 1.0 ],
					"elementcolor" : [ 0.298039215686275, 0.298039215686275, 0.298039215686275, 1.0 ],
					"id" : "obj-3",
					"knobcolor" : [ 0.384313725490196, 1.0, 0.0, 1.0 ],
					"maxclass" : "slider",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					...
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 2.0, 12.0, 116.0 ],
					"size" : 158.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 47.0, 2.0, 20.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 2.0, 20.0, 116.0 ],
					"stripecolor" : [ 0.513726, 0.572549, 0.592157, 1.0 ]
				}
...
, 			{
		...
		"default_bgcolor" : [ 0.223529411764706, 0.211764705882353, 0.211764705882353, 1.0 ]
	}
