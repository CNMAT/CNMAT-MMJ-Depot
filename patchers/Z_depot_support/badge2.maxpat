...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 2.0, 47.0, 20.0 ],
					"text" : "#1 by #2",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 274.0, 57.0, 19.0 ],
					"text" : "uc_license"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-rebuilt_11292021/patchers/Z_depot_support",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "cnmat_blue.gif",
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-lastrelease-fullcopy/media/Images",
				"patcherrelativepath" : "../../../CNMAT-MMJ-Depot-lastrelease-fullcopy/media/Images",
				"type" : "GIFf",
				"implicit" : 1
			}
 ],
