...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "cnmat.o.buffer.player~", "basic utility for playing sound files with 0-1 phase lookup, designed to work with cnmat.o.buffer~", "0 0 0 0.75" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "cnmat.o.buffer.player~", 1, "Rama Gottfried" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 2.0, 628.0, 296.0, 86.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 308.0, 498.0, 189.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 112.0, 252.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 308.0, 367.0, 128.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.5, 652.0, 33.0, 22.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.5, 652.0, 74.0, 22.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 372.5, 85.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.5, 124.0, 217.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 621.0, 72.0, 321.0, 100.0 ],
					"text" : "/buffer/name sets buffer to play.\n\n/buffer/selected/start and /buffer/selected/end are used to scale the incoming phase to that region of the file.\n\nto play the buffer, double click on cnmat.o.buffer~ and then click the circle button in the bottom right"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 621.0, 43.0, 201.0, 27.0 ],
					"text" : "cnmat.o.buffer.player~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 192.0, 136.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 313.0, 177.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 308.0, 536.0, 48.0, 138.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 692.0, 37.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 365.5, 544.0, 143.5, 89.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 308.0, 452.0, 94.0, 22.0 ],
					"text" : "cnmat.phase~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 308.0, 415.0, 189.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 329.0, 176.0, 177.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 236.0, 94.0, 115.0, 47.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 236.0, 175.0, 92.0, 22.0 ],
					"text" : "cnmat.o.buffer~"
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Desktop/Summer Research/from Rama/patchers/io/samples",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
