...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "cnmat.o.io.cv.blobs", "", "0 0 0 0.75" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ -18.0, -68.0 ],
					"patching_rect" : [ 3.0, 5.0, 511.0, 76.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "cnmat.o.io.cv.blobs", 1, "Rama Gottfried" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 649.0, 684.0, 296.0, 86.0 ],
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 62.0, 547.0, 48.0, 35.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "/planecount : 4,\n/jitter/type : \"char\",\n/dimension : [1920, 1080],\n/aspect_ratio : 1.77778,\n/type : \"argb\",\n/jitter/name : \"u410001812\",\n/ms : 32.8709,\n/fps : 30.4221,\n/resize/height : 400,\n/threshold/mode : 0,\n/threshold/radius : 20.,\n/threshold/threshold : 5.,\n/resize/dimension : [400, 225],\n/x : -0.00510651,\n/y : -0.00431905,\n/bounds/x1 : -1.,\n/bounds/x2 : 0.995,\n/bounds/y1 : 1.,\n/bounds/y2 : -0.991111,\n/bounds/width : 0.9975,\n/bounds/height : 0.995556,\n/bounds/area : 0.993067,\n/area : 0.978378,\n/sqrt_area : 0.98913,\n/oriented/x : 0.98877,\n/oriented/y : 0.026663,\n/r : 0.0117647,\n/g : 0.00392157,\n/b : 0.,\n/luma : 0.00765991,\n/skew/x : -0.00241595,\n/skew/y : -0.012041,\n/orientation : 0.0269593,\n/elongation : 0.0137986,\n/direction : 0.0269593,\n/id : 4,\n/screen/aspect_ratio : 1.77778",
...
,
					"patching_rect" : [ 315.5, 646.0, 84.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 409.0, 646.0, 66.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 699.0, 249.0, 89.0, 22.0 ],
					"text" : "loadmess 0.05"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 699.0, 503.0, 85.0, 22.0 ],
					"text" : "loadmess 400"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 547.0, 221.0, 103.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 699.0, 536.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 699.0, 567.0, 144.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 62.0, 515.0, 110.0, 22.0 ],
					"text" : "cnmat.o.io.cv.blobs"
				}
...
,
					"patching_rect" : [ 375.5, 536.0, 66.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.5, 351.0, 72.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.0, 351.0, 79.0, 22.0 ],
					"text" : "loadmess 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 452.0, 351.0, 72.0, 22.0 ],
					"text" : "loadmess 5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 375.5, 382.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 375.5, 454.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.5, 418.5, 52.0, 20.0 ],
					"text" : "/mode $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 544.0, 387.5, 48.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.0, 421.5, 54.0, 20.0 ],
					"text" : "/radius $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 452.0, 384.5, 48.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 452.0, 418.5, 68.0, 20.0 ],
					"text" : "/threshold $1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 834.333312999999976, 44.0, 174.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 936.333312999999976, 683.0, 103.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 895.333312999999976, 617.5, 113.0, 49.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 895.333312999999976, 584.0, 34.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 895.333312999999976, 541.0, 57.0, 22.0 ],
									"text" : "zl.ecils 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 895.333312999999976, 505.0, 153.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 895.333312999999976, 717.0, 116.0, 76.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 543.333374000000049, 709.0, 149.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 366.333312999999976, 651.0, 57.0, 22.0 ],
									"text" : "zl.ecils 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 366.333312999999976, 571.5, 57.0, 22.0 ],
									"text" : "zl.ecils 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 366.333312999999976, 612.5, 34.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 366.333312999999976, 536.5, 153.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 366.333312999999976, 696.0, 149.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 366.333312999999976, 501.0, 50.0, 22.0 ],
									"text" : "t l b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 707.333312999999976, 702.5, 113.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 834.333312999999976, 1.5, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 0 ],
									"midpoints" : [ 843.833312999999976, 80.75, 29.0, 80.75 ],
									"source" : [ "obj-11", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-24", 0 ],
									"midpoints" : [ 406.833312999999976, 534.75, 716.833312999999976, 534.75 ],
									"source" : [ "obj-8", 1 ]
								}
...
,
					"patching_rect" : [ 32.5, 671.5, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 616.0, 397.0, 50.0, 22.0 ],
					"text" : "0.05"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 77.5, 157.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 699.0, 289.0, 20.0, 140.0 ],
					"setminmax" : [ 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 697.5, 442.0, 158.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 31.5, 164.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 31.5, 190.5, 65.0, 22.0 ],
					"text" : "qmetro 20"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 31.5, 221.0, 500.0, 92.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 191.0, 105.0, 22.0 ],
					"text_width" : 66.0
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cnmat.grab.bp.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/Music-and-Computing/patchers/io/camera/abstractions",
				"patcherrelativepath" : "../../../../../Documents/Max 8/Packages/Music-and-Computing/patchers/io/camera/abstractions",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "cnmat.o.io.cv.blobs.maxpat",
				"bootpath" : "~/Desktop/Summer Research/from Rama/io/camera",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
