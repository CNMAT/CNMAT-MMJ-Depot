...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 930.0, 690.0, 296.0, 86.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 220.0, 10.0, 503.0, 74.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 69.0, 73.0, 22.0 ],
					"text" : "loadmess 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 695.0, 280.0, 451.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1125.0, 75.0, 24.0, 24.0 ]
				}
...
,
					"patching_rect" : [ 1125.0, 110.0, 53.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1015.0, 194.5, 76.0, 22.0 ],
					"text" : "o.route /path"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 888.0, 75.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1052.5, 75.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 985.0, 75.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1015.0, 224.5, 79.0, 22.0 ],
					"text" : "prepend path"
				}
...
,
					"patching_rect" : [ 1052.5, 110.0, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 888.0, 110.0, 71.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 985.0, 110.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 69.0, 93.0, 22.0 ],
					"text" : "loadmess 0.187"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 110.0, 161.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 586.0, 194.5, 89.0, 22.0 ],
					"style" : "default",
					"text" : "make_circle 16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 485.0, 194.5, 35.0, 22.0 ],
					"style" : "default",
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 135.5, 72.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 985.0, 40.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 15.0, 740.0, 72.0, 22.0 ],
					"text" : "mirror2odot"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 505.0, 610.0, 278.0, 85.0 ],
					"text" : "/metalist : [0.025283, -0.598868, -0.025283, 0.598868, 0.05],\n/phasepoint : [0.025283, -0.598868],\n/phasemirror : [-0.025283, 0.598868],\n/size : 0.05"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 194.5, 84.0, 22.0 ],
					"text" : "flip_y_axis $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 165.5, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 245.0, 161.0, 29.5, 22.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 535.0, 194.5, 37.0, 22.0 ],
					"text" : "open"
				}
...
,
					"patching_rect" : [ 30.0, 230.0, 41.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.0, 100.0, 72.0, 22.0 ],
					"text" : "loadmess 6"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 75.0, 85.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 245.0, 130.0, 50.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 30.0, 200.0, 234.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 110.0, 70.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.0, 230.0, 130.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 415.0, 194.5, 52.0, 22.0 ],
					"style" : "default",
					"text" : "compile"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 55.0, 310.0, 422.0, 422.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 24.5, 772.0, 494.5, 772.0, 494.5, 598.0, 514.5, 598.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 994.5, 175.5, 1136.5, 175.5 ],
					"order" : 0,
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 1 ],
					"midpoints" : [ 897.5, 175.5, 1136.5, 175.5 ],
					"order" : 0,
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 1 ],
					"midpoints" : [ 1062.0, 175.5, 1136.5, 175.5 ],
					"order" : 0,
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 1 ],
					"midpoints" : [ 1134.5, 175.5, 1136.5, 175.5 ],
					"order" : 0,
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "mirrorpath.js",
				"bootpath" : "~/Dropbox/My Mac (CNMATs-MacBook-Pro.local)/Documents/Max 8/Packages/CNMAT-MMJ-Depot-F201-EC-IMRAN/patchers/mixing/mirrorpath",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
