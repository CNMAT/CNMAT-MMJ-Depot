...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "cnmat.o.gui.function", "parses the GUI info from function object into something more usable", "0 0 0 0.75" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ -18.0, -68.0 ],
					"patching_rect" : [ 8.5, 6.5, 511.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 2.0, 659.0, 296.0, 86.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 792.25, 641.0, 59.0, 20.0 ],
					"text" : "see also:"
				}
...
, 			{
				"box" : 				{
					"allowdrag" : 0,
					"id" : "obj-30",
					"items" : [ "o.gui.attach", ",", "cnmat.o.phase.points~", ",", "cnmat.o.gui.table", ",", "cnmat.o.gui.live.grid", ",", "function" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 853.25, 641.0, 155.5, 22.0 ]
				}
...
,
					"patching_rect" : [ 921.5, 667.266173999999978, 65.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 921.5, 698.41589399999998, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.5, 157.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.5, 157.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 469.5, 189.0, 50.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 537.234069999999974, 0.6, 0, 707.446837999999957, 0.96, 0, 1000.0, 0.0, 0 ],
					"id" : "obj-21",
					"maxclass" : "function",
					"numinlets" : 1,
					"numoutlets" : 4,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 303.5, 229.0, 200.0, 100.0 ],
					"varname" : "/bpf/mod"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 322.0, 189.0, 142.0, 22.0 ],
					"text_width" : 66.5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.5, 189.0, 50.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.5, 229.0, 200.0, 100.0 ],
					"varname" : "/bpf/amp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.5, 189.0, 142.0, 22.0 ],
					"text_width" : 66.5
				}
