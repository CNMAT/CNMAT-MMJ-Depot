...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 790.0, 102.0, 47.0, 19.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"bgfillcolor_color1" : [ 0.6, 0.6, 0.701961, 1.0 ],
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 790.0, 54.0, 29.5, 22.0 ],
					"text" : "jsui",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 790.0, 81.0, 61.0, 19.0 ],
					"text" : "prepend help"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 633.0, 50.0, 150.0, 33.0 ],
					"text" : "markermanger requires the max jsui object"
				}

			}
, 			{
				"box" : 				{
					"args" : [ "markermanager", "ui to display input 'markers' and click-drag them", "0.7 0.4 0.2 1." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"offset" : [ -21.429089000000001, -70.503310999999997 ],
					"patching_rect" : [ 310.0, 435.094757000000016, 501.167602999999986, 71.018951000000001 ],
...
, 			{
				"box" : 				{
					"args" : [ "markermanager", 1.0, "Jeff Lubow", "markermanager", 6666, "0.7 0.4 0.2 1." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"offset" : [ -0.518023, 1.481977 ],
					"patching_rect" : [ 10.0, 426.0, 292.277221999999995, 84.094764999999995 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 220.0, 90.0, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 107.5, 46.0, 20.0 ],
									"text" : "uzi 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 50.0, 161.5, 41.0, 20.0 ],
									"text" : "/ 999."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 50.0, 134.5, 81.0, 20.0 ],
									"text" : "random 1000"
								}
...
,
					"patching_rect" : [ 503.875, 60.0, 36.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.333344000000011, 90.0, 52.0, 22.0 ],
					"text" : "compile"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 109.666672000000005, 350.0, 100.0, 22.0 ],
					"text" : "6 0.637143"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.333344000000011, 350.0, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 90.0, 57.0, 22.0 ],
					"text" : "move $1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 43.5, 180.0, 81.0, 20.0 ],
									"text" : "prepend tabs"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "int" ],
									"patching_rect" : [ 30.0, 110.0, 46.0, 20.0 ],
									"text" : "uzi"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 43.5, 150.0, 53.0, 20.0 ],
									"text" : "zl group"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 30.0, 80.0, 39.0, 20.0 ],
									"text" : "zl.len"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 43.5, 240.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 503.875, 90.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.5, 380.0, 87.0, 22.0 ],
					"text" : "prepend move"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 90.0, 75.0, 22.0 ],
					"text" : "getmarker 7"
				}
...
,
					"patching_rect" : [ 10.0, 350.0, 95.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 10.0, 310.0, 561.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 90.0, 37.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 740.0, 160.0, 50.0, 22.0 ],
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 740.0, 230.0, 141.0, 22.0 ],
					"text" : "buffer~ tester moanin.aiff"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.956658, 1.0, 0.937049, 1.0 ],
					"buffername" : "tester",
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Dropbox/My Mac (CNMATs-MacBook-Pro.local)/Documents/Max 8/Packages/CNMAT-MMJ-Depot-F201-EC/jsui",
