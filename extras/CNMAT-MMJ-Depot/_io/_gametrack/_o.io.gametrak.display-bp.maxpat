...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "o.io.gametrak.display-bp.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 7.0, -19.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"name" : "o.io.gametrak.display-bp.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-2-Jon-230810/patchers/io/gametrak",
				"patcherrelativepath" : "../../../../patchers/io/gametrak",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
