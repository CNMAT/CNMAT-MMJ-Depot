...
, 			{
				"box" : 				{
					"args" : [ "stereo~", "by", "originally_Lubow", 6666, "0.1 0.1 0.1 0.5" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "stereo~", "Play audio out two channels", "0.1 0.1 0.1 0.5" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "banner.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-2_031122/patchers/Z_depot_support",
...
, 			{
				"name" : "CNMAT_logo.png",
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-2_031122/media/Images",
...
, 			{
				"name" : "stereo~.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-2_031122/patchers/mixing",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
