...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.5, 288.0, 46.0, 20.0 ],
					"text" : "/loop $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 40.0, 230.0, 32.5, 20.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 230.0, 47.0, 20.0 ],
					"text" : "addpath"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 367.0, 85.0, 20.0 ],
					"text" : "send~ sonogram"
				}
...
,
					"patching_rect" : [ 216.0, 464.0, 72.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 476.0, 408.0, 103.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 288.0, 52.0, 20.0 ],
					"text" : "r AS-help"
				}
...
,
					"patching_rect" : [ 468.0, 428.0, 114.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"args" : [ "audition-soundfiles-app~", "preview a folder of sounds", "0.435 0.435 0.435 1." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 452.0, 220.0, 32.5, 20.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 452.0, 284.0, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 452.0, 304.0, 79.0, 20.0 ],
					"text" : "sprintf /play/%d"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 452.0, 260.0, 138.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 268.0, 420.0, 183.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.0, 184.0, 40.0, 20.0 ],
					"text" : "/play/2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 168.0, 32.5, 20.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 168.0, 32.5, 20.0 ],
					"text" : "0.05"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.0, 288.0, 46.0, 20.0 ],
					"text" : "/gain $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 252.0, 264.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 212.0, 54.0, 20.0 ],
					"text" : "/play/1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 116.0, 47.0, 20.0 ],
					"text" : "/choose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 252.0, 78.0, 20.0 ],
					"text" : "prepend /folder"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 212.0, 368.0, 211.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 40.0, 340.0, 191.0, 20.0 ],
					"text" : "audition-soundfiles-app~ 0.8 @verbose 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 212.0, 404.0, 35.0, 20.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 404.0, 199.0, 20.0 ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 349.5, 392.0, 446.166655999999989, 392.0, 446.166655999999989, 255.0, 461.5, 255.0 ],
					"source" : [ "obj-1", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 285.5, 399.5, 449.5, 399.5 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 261.5, 324.669738999999993, 49.5, 324.669738999999993 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 405.5, 336.851500999999985, 49.5, 336.851500999999985 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 377.5, 332.372710999999981, 49.5, 332.372710999999981 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 330.0, 328.345459000000005, 49.5, 328.345459000000005 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 69.5, 310.82742300000001, 49.5, 310.82742300000001 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 213.5, 315.854645000000005, 49.5, 315.854645000000005 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 237.5, 320.642487000000017, 49.5, 320.642487000000017 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"name" : "audition-soundfiles-app~.maxpat",
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-2-Jon-230810/patchers/audio_sample_record_and_play/sample/CNMAT_samplers/sampler abs needs help file",
				"patcherrelativepath" : "../../../../patchers/audio_sample_record_and_play/sample/CNMAT_samplers/sampler abs needs help file",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
