...
,
					"patching_rect" : [ 681.5, 654.0, 46.0, 19.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "ali.gauss-kern.help", "1.0b", "Rafael  Ali momeni", "ali.gauss-kern", 6666, "0.296 0.594 0.784 0.5" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 598.0, 599.0, 296.0, 86.0 ],
...
,
					"patching_rect" : [ 206.0, 508.0, 181.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 746.0, 352.0, 133.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 669.0, 359.0, 75.0, 19.0 ],
					"text" : "prepend lookup"
				}
...
,
					"patching_rect" : [ 669.0, 336.0, 40.0, 19.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 669.0, 384.0, 55.0, 19.0 ],
					"text" : "s to-space"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 741.0, 27.0, 151.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 442.0, 516.0, 128.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 117.0, 52.0, 22.0 ],
					"text" : "compile"
				}
...
,
					"patching_rect" : [ 449.0, 198.0, 51.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 449.0, 245.0, 71.0, 22.0 ],
					"text" : "s to-space"
				}
...
,
					"patching_rect" : [ 34.0, 552.0, 44.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 117.0, 64.0, 22.0 ],
					"text" : "r to-space"
				}
...
,
					"patching_rect" : [ 206.0, 548.0, 177.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 556.0, 222.0, 293.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 449.0, 222.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.0, 101.0, 279.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.0, 69.0, 267.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 633.0, 569.0, 53.0, 19.0 ],
					"restore" : 					{
						"ali-js-interp" : [ -0.4, 0, 1, 0.5, 0.5, 1, 0, 0, 0.906786, 0.46695, 1.040067, 0.211515, 0.145721, 0, 0, 1, -0.25, -0.65, 0.32, 0.1, 1, 0, 1, 0, 0.593478, -0.46695, 1, 0.5, 0.5, 0.329412, 0.972549, 1, 0.078091, -0.168196, 0.362957, 0.5, 0.5, 0.580392156862745, 1, 0.419607843137255, -0.732057, 0.430799, 0.586674, 0.14, 0.14, 1, 0, 0, 0.111465, 0.85256, 1, 0.14, 0.14, 1, 0, 0 ]
					}
,
					"text" : "autopattr",
					"varname" : "u503000798"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 633.0, 541.0, 145.0, 19.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "pattrstorage-bp.maxpat",
					"numinlets" : 5,
					"numoutlets" : 1,
					"offset" : [ -1.0, -5.0 ],
					"outlettype" : [ "clear" ],
					"patching_rect" : [ 633.0, 478.0, 218.0, 55.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 34.0, 587.0, 40.0, 22.0 ],
...
,
					"patching_rect" : [ 206.0, 528.0, 106.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					"args" : [ "ali.gauss-kern", "weight generator with gaussian kernels", "0.296 0.594 0.784 0.5" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 19.0, 19.0, 408.0, 76.0 ],
					"presentation" : 1,
