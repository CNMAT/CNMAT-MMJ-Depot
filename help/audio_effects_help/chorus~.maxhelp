...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 98.0, 135.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "chorus~.help", "1.1b", " Wright & Zbyszynski", "chorus~", 2736, "0.296 0.594 0.784 1." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "chorus~", "a simple mono chorus with variable feedback", "0.296 0.594 0.784 1." ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.0, 218.0, 82.0, 22.0 ],
					"text" : "loadmess 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 69.0, 240.0, 40.0, 22.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 33.0, 166.0, 66.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 33.0, 200.0, 70.0, 22.0 ],
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 187.0, 126.0, 49.0, 22.0 ],
					"text" : "sfplay~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 33.0, 262.0, 54.0, 22.0 ],
					"text" : "chorus~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 448.0, 37.0, 22.0 ],
					"text" : "dac~"
				}
