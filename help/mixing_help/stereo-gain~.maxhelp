...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 373.0, 364.0, 65.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 292.0, 364.0, 65.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 425.0, 106.0, 150.0, 31.0 ],
					"text" : "set gain level\n0-127 smoothly"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 373.0, 106.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.735291000000018, 316.0, 119.0, 61.0 ],
					"text" : "ARGUMENT\n<get info/arguments> set default gain level  on opening of patch\n",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 292.0, 139.0, 57.0, 20.0 ],
					"text" : "cycle~ 440"
				}
...
, 			{
				"box" : 				{
					"args" : [ "stereo-gain~", "by", "originally_Lubow", 6666, "0.1 0.1 0.1 0.5" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "stereo-gain~", "Play audio out two channels", "0.1 0.1 0.1 0.5" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"name" : "stereo-gain~.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-2_032225/patchers/mixing",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
