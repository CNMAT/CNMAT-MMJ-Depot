...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "pstore-simple-storage.maxpat",
				"bootpath" : "~/Dropbox/My Mac (CNMATs-MacBook-Pro.local)/Documents/Max 8/Packages/CNMAT-MMJ-Depot-F201-EC/patchers/data_storage_and_presets",
				"patcherrelativepath" : "../../patchers/data_storage_and_presets",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
