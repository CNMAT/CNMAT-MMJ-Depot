...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "cnmat.o.io.bcf2k.ui", "a GUI for displaying and setting values of the BCF2000, used in connection with the cnmat.o.io.bcf2k wrapper", "0 0 0 0.75" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ -18.0, -68.0 ],
					"patching_rect" : [ 688.0, 15.0, 511.0, 76.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "cnmat.o.io.bcf2k.ui", 1, "Rama Gottfried" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 903.0, 618.0, 296.0, 86.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.5, 234.0, 185.0, 1217.0 ],
					"text" : "/fader/6 : 104,\n/grp/c/encoder/6 : 67,\n/grp/c/encoder/7 : 0",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cnmat.o.io.bcf2k.ui.maxpat",
				"bootpath" : "~/Desktop/Summer Research/Depot 2.0/patchers/io/BCF2000",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
