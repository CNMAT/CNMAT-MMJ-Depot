...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 213.0, 427.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 387.0, 47.0, 20.0 ],
					"text" : "3. click"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 316.0, 418.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 407.0, 163.0, 22.0 ],
					"text" : "/slider1 70"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"dial1" : [ 0 ],
						"multi1" : [ 0.180000007152557, 0.180000007152557, 0.180000007152557, 0.180000007152557, 0.180000007152557, 0.180000007152557, 0.180000007152557, 0.140000000596046, 0.119999997317791, 0.093333333730698, 0.066666670143604, 0.03999999910593, -0.019999999552965, -0.03999999910593, -0.079999998211861, -0.340000003576279 ],
						"slider1" : [ 0 ]
					}
,
...
, 			{
				"name" : "thispatch.json",
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot/extras/CNMAT-MMJ-Depot/tutors/object-tutors/about_pattr_family",
				"patcherrelativepath" : "../../extras/CNMAT-MMJ-Depot/tutors/object-tutors/about_pattr_family",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
