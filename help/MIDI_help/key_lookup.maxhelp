...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 326.0, 437.0, 68.0 ],
					"text" : "This can also be mapped by sending the message /vel n to the input of of the bpatcher abstraction.  key_lookup seeks to be expanded in the sense that other virtual keyboard mappings can be added to it via text files.  If you'd like to change the current mapping, simply open up the editor by clicking on the button and 'save as...' to a file which you can load by name afterward.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 20.0, 318.0, 100.0, 192.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 961.0, 108.0, 100.0, 190.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "key_lookup", "1.0_alpha", "Jeff Lubow", "key_lookup", 6666, "0.5 0.5 0.5 0.5" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 444.0, 416.0, 296.0, 86.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "key_lookup", "A graphically-based keyboard that can be loaded as a bpatcher.", "0.5 0.5 0.5 0.5" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ -18.0, -68.0 ],
					"patching_rect" : [ 232.0, 15.0, 511.0, 76.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 24.0, 384.0, 44.057144000000001, 18.0 ],
									"text" : "length"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 100.0, 337.799987999999985, 32.0, 19.0 ],
									"text" : "t b s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 360.799987999999985, 67.0, 17.0 ],
									"text" : "sort -1 -1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 314.799987999999985, 78.0, 19.0 ],
									"text" : "prepend store"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 291.799987999999985, 45.0, 19.0 ],
									"text" : "pack i i"
								}
...
,
					"patching_rect" : [ 568.0, 228.0, 95.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 264.0, 431.0, 56.0 ],
					"text" : "To use key_lookup, you simply load a given mapping set and begin typing on your keyboard to play the notes for that particular mapping.  Because you don't have access to velocity on a computer keyboard, you can use the slider to adjust the output velocty as you play.",
					"textcolor" : [ 0.901961, 0.811765, 0.811765, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"fontname" : "Arial",
					"fontsize" : 10.647220000000001,
					"id" : "obj-21",
					"maxclass" : "message",
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.0, 44.0, 83.0, 20.0 ],
					"text" : "lookup_renoise"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 80.0, 49.0, 20.0 ],
					"text" : "/load $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 44.0, 79.0, 20.0 ],
					"text" : "lookup_vsamp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 237.5, 32.0, 21.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 20.0, 284.0, 80.0, 21.0 ],
					"text" : "mz.sawsynth~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 261.0, 75.0, 20.0 ],
					"text" : "/frequency $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 12.0, 107.0, 21.0 ],
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-2-Jon-230810/patchers/synthesis/mz_synth_toys",
				"patcherrelativepath" : "../../patchers/synthesis/mz_synth_toys",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
