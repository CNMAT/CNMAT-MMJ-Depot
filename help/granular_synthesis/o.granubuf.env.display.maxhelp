...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "o.granubuf.env.display", "a helper bpatcher to show effects of xshape and yshape on o.granubuf~'s internal raised-cosine envelope.", "0 0 0 0.75" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "o.granubuf.env.display", 1, "Rama Gottfried" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 458.0, 447.0, 296.0, 86.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 332.5, 191.0, 103.0, 22.0 ],
					"text" : "varname /yshape"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 218.5, 191.0, 103.0, 22.0 ],
					"text" : "varname /xshape"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 46.0, 187.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 220.0, 138.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 266.0, 72.0, 22.0 ],
					"text" : "o.gui.attach"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 332.5, 224.5, 50.0, 22.0 ],
					"varname" : "/yshape"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 218.5, 224.5, 50.0, 22.0 ],
					"varname" : "/xshape"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 46.0, 334.0, 410.0, 106.0 ],
					"viewvisibility" : 1
				}
