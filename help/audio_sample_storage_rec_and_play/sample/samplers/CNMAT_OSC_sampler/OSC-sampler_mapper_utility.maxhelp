...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-17",
					"items" : [ "Adrian_sound_a.wav", ",", "Adrian_sound_b.wav", ",", "Adrian_sound_c.wav", ",", "Adrian_sound_d.wav", ",", "Nathan_snd1.wav", ",", "Nathan_snd2.wav", ",", "Nathan_snd3.wav", ",", "Nathan_snd4.wav", ",", "Nathan_snd5.wav", ",", "peter-emergence-maintenance-release-2.wav", ",", "peter-emergence-transition-disappearance-2.wav", ",", "peter-upbeat-passage-release-2.wav", ",", "Alfred_no_clarinet1.aif", ",", "Alfred_no_clarinet2.aif", ",", "Alfred_no_clarinet3.aif", ",", "Alfred_no_clarinet4.aif", ",", "Alfred_no_clarinet5.aif", ",", "Alfred_no_clarinet6.aif" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-F201/patchers/samples",
				"patcherrelativepath" : "../../patchers/samples",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
